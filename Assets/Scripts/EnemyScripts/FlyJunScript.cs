...
public class FlyJunScript : MonoBehaviour {
  ...
  void Start() {
    ...
    if (transform.parent) {
      if (transform.parent.tag == "EnemyGenerater") {
        ...
        this.key = this.generaterScript.handOverFloat[4];
      }
    }
  }
  ...
  private void FixedUpdate() {
    ...
    rigid2d.velocity = new Vector2(xSpeed * key, vy * ySpeed);
  }
